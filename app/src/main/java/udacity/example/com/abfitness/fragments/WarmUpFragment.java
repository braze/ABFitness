...
public class WarmUpFragment extends Fragment implements Player.EventListener{
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(INTENT_STRING_URL, mWarmUpVideoUrl);
    }

    private void initPrepareAndPlay() {
        initializeMediaSession();
        initPlayer(Uri.parse(mWarmUpVideoUrl));
