...
public class CoolDownFragment extends Fragment implements Player.EventListener {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(INTENT_STRING_URL, mCoolDownVideoUrl);
    }

    private void initPrepareAndPlay() {
        initializeMediaSession();
        initPlayer(Uri.parse(mCoolDownVideoUrl));
